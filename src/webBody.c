static const char* HTML_RESPONSE = "<!DOCTYPE html><html><head>"
                                    ...
                                    "</div>"
                                    //STAND BUTTON
                                    "<div class=\"additional_funnctions\">"
                                        "<button class=\"stand\" onmousedown=\"sendRequest('stand')\" ontouchstart=\"sendRequest('stand')\">"
                                        "STAND"
                                        "</button>"
                                        "<button class=\"sit\" onmousedown=\"sendRequest('sit')\" ontouchstart=\"sendRequest('sit')\">"
                                        "SIT"
                                        "</button>"
                                    "</div>"
                                    "<script>"
